...
if 'selected_vectorstore_name' not in st.session_state:
...
This is a retrieval augmented generation chatbot powered by various AI technologies including Langchain, Cohere, OpenAI, Google Generative AI, and Hugging Face.

Feel free to ask any questions or interact with our assistant!
""")
        st.write("")
